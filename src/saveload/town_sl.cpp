...
static const SaveLoad _town_desc[] = {
	...
	SLE_CONDVAR(Town, statues.data,               SLE_UINT16,               SLV_104, SL_MAX_VERSION),
	SLE_CONDARR(Town, statues.data,          SLE_UINT64, CompanyMask::bsize, SLV_196, SL_MAX_VERSION),

	SLE_CONDVAR(Town, have_ratings.data,          SLE_FILE_U8  | SLE_VAR_U16, SL_MIN_VERSION, SLV_104),
	SLE_CONDVAR(Town, have_ratings.data,          SLE_UINT16,               SLV_104, SL_MAX_VERSION),
	SLE_CONDARR(Town, ratings,               SLE_INT16, 8,               SL_MIN_VERSION, SLV_104),
	SLE_CONDARR(Town, ratings,               SLE_INT16, OLD_MAX_COMPANIES, SLV_104, SL_MAX_VERSION),
	SLE_CONDARR(Town, unwanted,              SLE_INT8,  8,               SLV_4, SLV_104),
	SLE_CONDARR(Town, unwanted,              SLE_INT8,  OLD_MAX_COMPANIES, SLV_104, SL_MAX_VERSION),
	SLE_CONDARR(Town, unwanted,              SLE_INT8,  MAX_COMPANIES, SLV_196, SL_MAX_VERSION),
