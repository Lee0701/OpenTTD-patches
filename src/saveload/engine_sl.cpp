...
static const SaveLoad _engine_desc[] = {
	 ...
	 SLE_CONDVAR(Engine, preview_asked.data,       SLE_UINT16,                SLV_179, SL_MAX_VERSION),
	 SLE_CONDARR(Engine, preview_asked.data,  SLE_UINT64, CompanyMask::bsize, SLV_196, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, preview_company,     SLE_UINT8,                 SLV_179, SL_MAX_VERSION),
	     SLE_VAR(Engine, preview_wait,        SLE_UINT8),
	 SLE_CONDVAR(Engine, company_avail.data,       SLE_FILE_U8  | SLE_VAR_U16,  SL_MIN_VERSION, SLV_104),
	 SLE_CONDVAR(Engine, company_avail.data,       SLE_UINT16,                SLV_104, SL_MAX_VERSION),
	 SLE_CONDARR(Engine, company_avail.data,  SLE_UINT64, CompanyMask::bsize, SLV_196, SL_MAX_VERSION),
	 SLE_CONDVAR(Engine, company_hidden.data,      SLE_UINT16,                SLV_193, SL_MAX_VERSION),
	 SLE_CONDARR(Engine, company_hidden.data, SLE_UINT64, CompanyMask::bsize, SLV_196, SL_MAX_VERSION),
